...
public class TecbotConstants {
        ...
        public static final double K_CHASSIS_ENCODER_TO_METERS = (1 / K_CHASSIS_TIC_PER_REVOLUTION)
                        * K_CHASSIS_WHEEL_DIAMETER
                        * Math.PI;
        ...
        public static final double K_CHASSIS_METERS_TO_ENCODER = (float) (K_CHASSIS_TIC_PER_REVOLUTION
                        / (K_CHASSIS_WHEEL_DIAMETER * Math.PI));
        // This only works for the middle wheel
        public static final double K_MIDDLE_WHEEL_METERS_TO_ENCODER = (float) (K_MIDDLE_WHEEL_TIC_PER_REVOLUTION
                        / (K_MIDDLE_WHEEL_DIAMETER * Math.PI));
