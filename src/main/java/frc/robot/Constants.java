...
public final class Constants {
    ...
    public static final Pose2d SHOOTING_POSITION = new Pose2d(14.93, 5.5, new Rotation2d(Math.PI));
    
    public static final HolonomicPathFollowerConfig pathFollowerConfig = new 
    HolonomicPathFollowerConfig(new PIDConstants(1.5, 0.02), 
    new PIDConstants(1.45, 0.007), 
    ...
    public static final double PILOT_DRIVING_DEADZONE = 0.1;
